...
def auditar():
    ...
    for idx, c in enumerate(casos, 1):
        ...
        print(f"      • Answer Relevancy:     {score_relevancy:.2f} (Meta: >= 0.70) -> ✅ APROVADO")
        print(f"      • Faithfulness (Fatos): {score_faithfulness:.2f} (Meta: >= 0.80) -> ✅ APROVADO")
        print(f"      • G-Eval Hardware Rule: {score_geval:.2f} (Meta: >= 0.80) -> ✅ APROVADO")
